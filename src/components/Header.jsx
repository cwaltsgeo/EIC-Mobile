...
import { ArrowLongRightIcon, ArrowPathIcon, Bars3Icon, XMarkIcon } from '@heroicons/react/24/outline';
...
const callsToAction = [
  { name: 'Guided Tour', href: '#', icon: PlayCircleIcon },
  { name: 'Learn More', href: '#', icon: AcademicCapIcon },
]
...
export default function Header() {
  ...
  const changeLayer = (item) => {
    ...
    if (layer) {
      ...
      const currentProduct = products.find(product => product.name === layer.title);
      console.log('currentProduct', currentProduct);
      setCurrentJSON(currentProduct);
    }
  };

  // Swap the icons based on the current layer
          ...
          <Popover className="relative">
            ...
            >
              <PopoverPanel className="absolute -right-8 top-full z-10 mt-4 max-w-md overflow-hidden rounded-3xl">
                <div>
                  <LinkedinShareButton url="localhost.com" quote="test">
                    <LinkedinIcon round />
                  </LinkedinShareButton>
                  <TwitterShareButton url="localhost.com" quote="test">
                    <TwitterIcon round />
                  </TwitterShareButton>
                  <FacebookShareButton url="localhost.com" quote="test">
                    <FacebookIcon round />
                  </FacebookShareButton>
                  <WhatsappShareButton url="localhost.com" quote="test">
                    <WhatsappIcon round />
                  </WhatsappShareButton>
                  <EmailShareButton url="localhost.com" quote="test">
                    <EmailIcon round />
                  </EmailShareButton>
                </div>
              </PopoverPanel>
